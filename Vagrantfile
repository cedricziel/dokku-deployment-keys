# Vagrantfile taken from https://github.com/jeffutter/dokku-mongodb-plugin
...
#      recipe[docker]
  ...
  config.vm.synced_folder "./", "/var/lib/dokku/plugins/deployment-keys", owner: "root", group: "root"
